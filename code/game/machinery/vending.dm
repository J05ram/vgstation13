...
/obj/machinery/vending
	...
	var/vend_reply				//Gracias por tu compra!
	var/last_reply = 0
	var/last_slogan = 0			//¿Cuando lanzamos por ultima vez?
	var/slogan_delay = 6000		//¿Cuánto tiempo hasta que podamos lanzar de nuevo?
...
/obj/machinery/vending/boozeomat
	...
	product_slogans = "Espero que nadie me pida una taza de té sangrienta ...;El alcohol es el amigo de la humanidad. ¿Abandonarias tu a un amigo?;¡Bastante encantado de servirle!;¿No hay nadie sediento en esta estación?"
	product_ads = "Las mejores bebidas estan aqui!;!Booze es bueno para ti!;El alcohol es el mejor amigo de la humanidad.;¡Bastante encantado de servirle!;¿Quieres una cerveza bien fria?;Nada te cura mejor que una buena bebida;¡Toma un sorbo!;¡Toma una copa!;¡Toma una cerveza!;¡La cerveza es buena para usted!;¡Tenemos solamente el alcohol mas fino!;¡La mejor calidad en bebidas desde 2053!;¡Vino premiado!;El hombre ama la cerveza.;¡Un brindis por el progreso!"
...
/obj/machinery/vending/assist
	...
	product_ads = "¡Tenemos solamente cosas de calidad!;Tenemos herramientas.;El equipo mas robusto.;¡Los equipos mas finos en el espacio!"
	pack = /obj/structure/vendomatpack/assist

/obj/machinery/vending/coffee
	name = "Hot Drinks machine"
	desc = "A vending machine that dispenses hot drinks."
	product_ads = "¡Bebete una bebida!;Un buen cafe calienta hasta el frio del vacio;¡Perfecto para ti!;¿Te gustaria un hot joe?;!Mataria por un cafe!;Los mejores beans en la galaxia.;Tenemos las bebidas mas finas para ti;Mmmm. Nada como un buen cafe.;Me gusta el cafe, y a ti?;¡El cafe te ayuda en tu trabajo!;Prueba el mejor tee de la galaxia.;¡Esperamos que te gusten nuestros productos!;¡Prueba nuestro nuevo chocolate!;Conspiracion de Admin."
	icon_state = COFFEE
...
/obj/machinery/vending/snack
	...
	product_slogans = "¡Prueba nuestra nueva barra de nougat!;¡Mitad de las calorias por un doble precio!;¡Es mejor que Dan's!"
	product_ads = "¡El mas sano!;¡Gana premios con nuestras barras de chocolates premiadas!;Mmm! Tan bueno!;¡Oh dios es tan jugoso!;Come un Snack;¡Los Snacks son buenos para ti!;¡Tengo unos obtengo mas!;Los mejores Snacks de calidad traidos desde marte.;¡Nos encanta el Chocolate!;¡Prueba nuestro nuevo Jerky!"
	icon_state = "snack"
	products = list(
...
/obj/machinery/vending/cola
	...
	product_slogans = "Robust Softdrinks: ¡Mas robusto que una caja de herramientas a la cabeza!;¡Almenos no somos la maquina Dan!"
	product_ads = "¡Las bebidas mas refrescantes!;¡Espero que tengas sed!¡Mas de 1 millón de bebidas vendidas!;¿Sediento? ¿Por que no tomas un refresco?;Tomate un trago refrescante!;Las mejores bebidas en el espacio."
	products = list(
...
/obj/machinery/vending/cigarette
	...
	product_slogans = "Space cigs buen sabor como un cigarrillo debe de saber;Prefiero una caja de herramientas que un interruptor;¡Fuma!;¡No creas en los informes - fuma hoy!"
	product_ads = "¡Probablemente no es malo para ti!;¡No le creas a los cientificos!;¡Es bueno para ti!;¡No te marches, compra mas!;¡Fuma!;Forma un cielo de nicotina.;Los mejores cigarros desde 2150.;Hay cigarros premiados."
	icon_state = "cigs"
	products = list(
...
/obj/machinery/vending/medical
	...
	icon_state = "med"
	icon_deny = "med-deny"
	product_ads = "¡Ve a salvar algunas vidas!;¡Las mejores cosas para tu medbay!;Solo los mejores instrumentos.;¡Productos quimicos naturales!;Estos materiales salvan vidas.;¿No quieres algo?;Ping!"
	products = list(
...
/obj/machinery/vending/wallmed1
	...
	//req_access = list(access_medical)
	product_ads = "¡Ve a salvar algunas vidas!;¡Las mejores cosas para tu medbay!;Solo los mejores instrumentos.;¡Productos quimicos naturales!;Estos materiales salvan vidas.;¿No quieres algo?"
	icon_state = "wallmed"
...
/obj/machinery/vending/security
	...
	product_ads = "Crack capitalist skulls!;¡Golpee algunas cabezas!;¡No olvide - el daño está bien!;¡Tus armas estan aqui!;¡Esposas!;¡Acaba con la escoria!;Tasea a todos los criminales!.;¿Por que no tener una rosquilla?"
	icon_state = "sec"
	icon_deny = "sec-deny"
	products = list(
...
/obj/machinery/vending/hydronutrients
	...
	product_slogans = "¿No estas contento de no tener que fertilizar de una forma natural?;¡Ahora con el 50% apesta menos!;¡Las plantas tambien son personas!"
	product_ads = "¡Nos gustan plantas!;¿No quieres algo?;Los pulgares mss verdes jamas vistos.;Nos gustan las plantas grandes.;Tierra suave..."
	icon_state = "nutri"
...
/obj/machinery/vending/hydroseeds
	...
	product_slogans = "¡Aqui es donde viven las semillas!;¡Sin duda la mejor selección de semilla sobre la estacion!;¡Tambien ciertas variedades de seta disponibles, mas para los expertos! ¡Obten la certificacion hoy!"
	product_ads = "¡Nos gustan las plantas!;¡Cultiva algunas cosechas!;¡Crecer, bebe, growww!;¡Adquiere tus semillas aqui!"
	icon_state = "seeds"
	products = list(
...
/obj/machinery/vending/voxseeds
	...
	product_slogans = "¡Semillas viviendo aqui! ¡Adquiere algunas!;Garras abajo, la mejor seleccion de semillas en los puestos de Vox;En ningun lugar encontraras mejores semillas."
	product_ads = "Haciendo un poco de salsa pronto;¡Tendras un crecimiento de ganancias!;¡Es bueno!;La comida Vox es la mejor."
	icon_state = "voxseed"
	products = list(
...
/obj/machinery/vending/magivend
	...
	icon_state = "MagiVend"
	product_slogans = "Sigue el camino apropiado con MagiVend.;¡Se tu propio Houdini! ¡Usa MagiVend!"
	vend_delay = 15
	vend_reply = "¡Ten una buena tarde hechizada!"
	product_ads = "FJKLFJSD;AJKFLBJAKL;1234 locos LOL!;>MFW;¡Mata a esos malditos!;CONSIGUE ESE MALDITO DISCO;HONK!;EI NATH!;¡Destruye la estacion!;¡Conspiraciones de admin desde siempre!;Tiempo-espacio doblando hardware"
	products = list(
...
/obj/machinery/vending/dinnerware
	...
	product_ads = "¡Mm, herramientas para la comida!;Accesorios de alimentos.;¡Consigue sus platos!;¿Te gustan los tenedores?;Me gustan los tenedores.;Woo, utensilios.;Realmente no necesitas estos..."
...
/obj/machinery/vending/sovietsoda
	...
	product_slogans = "BODA: Vendemos bebidas.;BODA: Bebe hoy.;BODA: Somos mejores que el Comrade Dan."
	product_ads = "Para Tsar y pais.;¿Ha hecho su checkeo de nutricion hoy?;¡Muy bien!;Nosotros somos gemple simple, por eso comemos aqui.;Si hay una persona, hay un problema. Si no hay ninguna persona, entonces no hay ningun problema."
	products = list(
...
/obj/machinery/vending/hatdispenser
	...
	product_ads = "¡Compra algunos sombreros!;¡Una cabeza desnuda es absolumante una peticion para ser robusteado!"
	product_slogans = "Advertencia, no todos los sombreros son compatibles con perros/monos.Ponganselos con cuidado.;Apliquese directamente en la frente.;¡¿A quien no gusta gastar dinero para comprar sombreros?!;Usar sombrero te hace mas guapo."
	products = list(
...
/obj/machinery/vending/suitdispenser
	...
	icon_state = "suits"
	vend_reply = "¡Regresa pronto!"
	product_ads = "¿Flaco? ¿Busca ropa? ¡Suitlord es la maquina para usted!;¡COMPRA MI PRODUCTO!"
	product_slogans = "Preplanchado, Prelavado, Pre-Wor-*BZZT *; ¡la Sangre de sus enemigos se lava directamente hacia fuera!;¿Que llevas puesto?;¡Mirada pulcra! ¡Parezcase a un idiota!;¿No lleva su tamaño? Como usted muchas personas se afeitan algunas libras de grasa - *BZZT*"
	products = list(
...
/obj/machinery/vending/shoedispenser
	...
	icon_state = "shoes"
	vend_reply = "¡Disfruta tus tennis nuevos!"
	product_ads = "No seas un hobbit: Elije ser un Shoelord.;¿Zapatos arrebatados? Consiga unos nuevos con Shoelord."
	product_slogans = "¡Cambia tu pie!; ¡Un tamaño encaja en todo!;¡YO ESTOY CAMINANDO EN EL SOL!;No se permiten Hobbits.;NO POR FAVOR WILLY, NO ME HAGAS DAÑO - *BZZT *"
	products = list(
...
/obj/machinery/vending/sovietvend
	...
	icon_state = "soviet"
	vend_reply = "¡El svin'ya fascista y capitalista caera, komrade!"
	product_ads = "¡Calidad vale la pena esperar en linea para conseguirlo!;¡Consiga Martillo y Sickled!; Sosvietsky soyuz sobre todo!;¡Con pigsky capitalista, usted habria pagado una fortunetink!"
...
/obj/machinery/vending/discount
	...
	product_slogans = "Discount Dan, el es el hombre!;No hay nada mejor en este mundo que una mordida de misterio.;¡No escuches a otras maquinas, compra mi producto!;Cantidad sobre calidad!;¡No escuche a aquellos intelectuales en el CDC, compra ahora!;Discount Dan's: ¡Estamos bien para usted! Nope, no podia decirlo con una cara directa.;Discount Dan's: Solo la mejor calidad en produ-*BZZT*"
	product_ads = "Discount Dan(tm) no es responsable de ningún daños y perjuicios causado por el mal uso de su producto."
	vend_reply = "No hay rembolsos."
	icon_state = DISCOUNT
	products = list(
...
/obj/machinery/vending/groans
	...
	product_slogans = "Groans: Tomate una bebida!;Patrocinado por Discount Dan!;¡Tomate un sorbo!;¡Solamente un sorbo, hazlo!"
	product_ads = "¡Prueba nuestro nuevo 'Double Dan' mucho sabor!"
	vend_reply = "No hay reembolsos."
	icon_state = "groans"
	products = list(
...
/obj/machinery/vending/nuka
	...
	product_slogans = "¡Un refrescamiento de energia nuclear!;Bebe como si no hubiera un mañana;Quita la tapa.. Y disfruta de una buena bebida."
	product_ads = "¿No te gustaria beber una fria Nuka cola justo en este momento?"
	vend_reply = "Disfruna de una Nuka Break!"
	icon_state = "nuka"
...
/obj/machinery/vending/trader	// Boxes are defined in trader.dm
	...
	product_ads = "¿Cuándo usted cobra a un cliente 100 dólares, y él le paga por equivocación 200 dólares, usted tiene un dilema ético - debería usted de devolver el cambio correctamente?"
	vend_reply = "Dinero dinero dinero!"
	icon_state = "voxseed"
	products = list (
		/obj/item/weapon/storage/fancy/donut_box = 2,
